...
class HSTabs extends HSBasePlugin<{}> implements ITabs {
	...
	private open(el: HTMLElement) {
		...
		this.fireEvent('change', { el, prev: this.prevContentId, current: this.currentContentId });
		this.dispatch('change.hs.tab', el, { el, prev: this.prevContentId, current: this.currentContentId });
	}
	...
	static getInstance(target: HTMLElement | string, isInstance?: boolean) {
		...
		// return targetInCollection || null;
...
window.addEventListener('load', () => {
	...
	.forEach((el: HTMLElement) => new HSTabs(el));
