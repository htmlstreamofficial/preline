				...
				887: function (t, e, s) {
					...
					class l extends o.default {
						...
						setSkipItem(t) {
							...
							e &&
								s &&
								(this.setSkipItemActions(e), this.setSkipItemActions(s));
						}
						...
						static autoInit() {
							(window.$hsStepperCollection ||
								...
								window.$hsStepperCollection &&
									(window.$hsStepperCollection =
										window.$hsStepperCollection.filter(({ element: t }) =>
