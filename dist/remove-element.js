		...
		var e = {
				...
				911: function (e, t, n) {
					...
					class s extends r.default {
						constructor(e, t) {
							super(e, t);
							const n = e.getAttribute('data-hs-remove-element-options'),
								o = n ? JSON.parse(n) : {},
							...
							((this.removeTargetId = this.el.getAttribute(
								...
								(this.removeTargetAnimationClass =
									(null == i ? void 0 : i.removeTargetAnimationClass) ||
									'hs-removing'),
						...
						remove() {
							...
							(this.removeTarget.classList.add(this.removeTargetAnimationClass),
								(0, i.afterTransition)(this.removeTarget, () =>
						...
						static getInstance(e, t) {
							const n = window.$hsRemoveElementCollection.find(
								(t) =>
									t.element.el ===
					...
					(window.addEventListener('load', () => {
						...
						'undefined' != typeof window && (window.HSRemoveElement = s),
						(t.default = s));
				},
				961: (e, t) => {
					Object.defineProperty(t, '__esModule', { value: !0 });
