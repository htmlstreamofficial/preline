!(function (e, t) {
	...
	(() => {
		...
		var e = {
				234: function (e, t, i) {
					...
					class s extends l.default {
						...
						previewAccepted(e) {
							const { previewElement: t } = e,
								...
								o = t.querySelector('[data-hs-file-upload-file-name]'),
								n = t.querySelector('[data-hs-file-upload-file-ext]'),
								l = t.querySelector('[data-hs-file-upload-file-size]'),
								s = t.querySelector('[data-hs-file-upload-file-icon]'),
							...
							(o && (o.textContent = i.name),
								...
								l && (l.textContent = this.formatFileSize(e.size)),
								r &&
									(e.type.includes('image/')
										? r.classList.remove('hidden')
										: this.setIcon(i.extension, s)),
						...
						onUploadProgress(e, t) {
							...
							if (!i) return !1;
							const o = i.querySelector('[data-hs-file-upload-progress-bar]'),
								n = i.querySelector('[data-hs-file-upload-progress-bar-pane]'),
								l = i.querySelector('[data-hs-file-upload-progress-bar-value]'),
								s = Math.floor(t);
							(o && o.setAttribute('aria-valuenow', `${s}`),
								n && (n.style.width = `${s}%`),
								l && (l.innerText = `${s}`));
						}
						onComplete(e) {
					...
					(window.addEventListener('load', () => {
						...
						'undefined' != typeof window && (window.HSFileUpload = s),
						(t.default = s));
				},
				292: function (e, t) {
					/*
					...
					t.isEnoughSpace = (e, t, i = 'auto', o = 10, n = null) => {
						const l = t.getBoundingClientRect(),
							s = n ? n.getBoundingClientRect() : null,
							a = window.innerHeight,
							r = s ? l.top - s.top : l.top,
							d = (n ? s.bottom : a) - l.bottom,
							p = e.clientHeight + o;
						return 'bottom' === i
							? d >= p
							: 'top' === i
					...
					t.afterTransition = (e, t) => {
						const i = () => {
							...
							n = o.getPropertyValue('transition-duration');
					...
					t.classToClassList = (e, t, i = ' ', o = 'add') => {
						e.split(i).forEach((e) => {
							e.trim() &&
		...
		var i = (function i(o) {
			...
			var l = (t[o] = { exports: {} });
			return (e[o].call(l.exports, l, l.exports, i), l.exports);
		})(234);
		return i;
	})(),
);
