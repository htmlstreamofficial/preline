!(function (t, e) {
	if ('object' == typeof exports && 'object' == typeof module)
		...
		var s = e();
		for (var o in s) ('object' == typeof exports ? exports : t)[o] = s[o];
	}
})(self, () =>
	(() => {
		'use strict';
		var t = {
				100: function (t, e, s) {
					...
					class l extends n.default {
						constructor(t, e) {
							super(t, e);
							const s = t.getAttribute('data-hs-toggle-password'),
								o = s ? JSON.parse(s) : {},
								n = Object.assign(Object.assign({}, o), e),
								l = [];
							if (
								(null == n ? void 0 : n.target) &&
								'string' == typeof (null == n ? void 0 : n.target)
							) {
								(null == n ? void 0 : n.target.split(',')).forEach((t) => {
									l.push(document.querySelector(t));
								});
							} else
								(null == n ? void 0 : n.target) &&
								'object' == typeof (null == n ? void 0 : n.target)
									? n.target.forEach((t) => l.push(document.querySelector(t)))
									: n.target.forEach((t) => l.push(t));
							((this.target = l),
								(this.isShown =
									!!this.el.hasAttribute('type') && this.el.checked),
								(this.eventType = (0, i.isFormElement)(this.el)
									? 'change'
									: 'click'),
								(this.isMultiple =
				...
				292: function (t, e) {
					...
					e.classToClassList = (t, e, s = ' ', o = 'add') => {
						t.split(s).forEach((t) => {
							t.trim() &&
		...
		var s = (function s(o) {
			...
			var n = (e[o] = { exports: {} });
			return (t[o].call(n.exports, n, n.exports, s), n.exports);
		})(100);
		return s;
	})(),
);
