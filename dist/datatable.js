	...
	(() => {
		...
		var e = {
				292: function (e, t) {
					...
					t.isEnoughSpace = (e, t, i = 'auto', n = 10, a = null) => {
						const s = t.getBoundingClientRect(),
							l = a ? a.getBoundingClientRect() : null,
							o = window.innerHeight,
							r = l ? s.top - l.top : s.top,
							h = (a ? l.bottom : o) - s.bottom,
							c = e.clientHeight + n;
						return 'bottom' === i
							? h >= c
							: 'top' === i
					...
					t.afterTransition = (e, t) => {
						const i = () => {
							...
							a = n.getPropertyValue('transition-duration');
				...
				814: function (e, t, i) {
					...
					class l extends s.default {
						constructor(e, t, i) {
							var n, a, s, l, o, r, h, c, g, d, u, p, f, v, b, S, m, w, P, L, y;
							(super(e, t, i),
								(this.el =
							...
							const C = this.el.getAttribute('data-hs-datatable'),
								T = C ? JSON.parse(C) : {};
									...
									(this.rowSelectingAll =
										null !==
											(f = (
												null ===
													(d =
														null === (g = this.concatOptions) || void 0 === g
															? void 0
															: g.rowSelectingOptions) || void 0 === d
													? void 0
													: d.selectAllSelector
											)
												? document.querySelector(
														null ===
															(p =
																null === (u = this.concatOptions) ||
																void 0 === u
																	? void 0
																	: u.rowSelectingOptions) || void 0 === p
															? void 0
															: p.selectAllSelector,
													)
												: document.querySelector(
												...
												null ===
													(S =
														null === (b = this.concatOptions) || void 0 === b
															? void 0
															: b.rowSelectingOptions) || void 0 === S
													? void 0
													: S.individualSelector) && void 0 !== m
											? m
											...
											null ===
												(L =
													null === (P = this.concatOptions) || void 0 === P
														? void 0
														: P.pagingOptions) || void 0 === L
												? void 0
												: L.pageBtnClasses) && void 0 !== y
										? y
										: null),
						...
						initSearch() {
							this.searches.forEach((e) => {
								(this.onSearchInputListener.push({
									el: e,
									fn: (0, a.debounce)((e) => this.searchInput(e)),
								}),
									e.addEventListener(
										'input',
						...
						updatePaging(e) {
							const {
								...
								l = Math.ceil(s / n),
								o = t + 1;
							let r = Math.max(1, o - Math.floor(this.maxPagesToShow / 2)),
								h = Math.min(l, r + (this.maxPagesToShow - 1));
							(h - r + 1 < this.maxPagesToShow &&
								(r = Math.max(1, h - this.maxPagesToShow + 1)),
								(e.innerHTML = ''),
								r > 1 &&
							...
							for (let t = r; t <= h; t++) this.buildPagingPage(t, e);
							(h < l &&
								(h < l - 1 &&
									e.appendChild(
										(0, a.htmlToElement)('<span class="ellipsis">...</span>'),
						...
						buildPagingPage(e, t) {
							const { page: i } = this.dataTable.page.info(),
								n = (0, a.htmlToElement)('<button type="button"></button>');
							((n.innerText = `${e}`),
								n.setAttribute('data-page', `${e}`),
								this.pageBtnClasses &&
									(0, a.classToClassList)(this.pageBtnClasses, n),
