				...
				292: function (t, e) {
					...
					e.getHighestZIndex = (t) => {
						...
						return (
							t.forEach((t) => {
								let n = i(t);
								'auto' !== n && ((n = parseInt(n, 10)), n > e && (e = n));
							}),
							e
						);
					};
					...
					e.isEnoughSpace = (t, e, i = 'auto', n = 10, o = null) => {
						const l = e.getBoundingClientRect(),
							r = o ? o.getBoundingClientRect() : null,
							s = window.innerHeight,
							a = r ? l.top - r.top : l.top,
							d = (o ? r.bottom : s) - l.bottom,
							c = t.clientHeight + n;
						return 'bottom' === i
							? d >= c
							: 'top' === i
					...
					e.classToClassList = (t, e, i = ' ', n = 'add') => {
						t.split(i).forEach((t) => {
							t.trim() &&
								('add' === n ? e.classList.add(t) : e.classList.remove(t));
						});
					};
					const o = {
						historyIndex: -1,
				...
				812: function (t, e, i) {
					...
					class r extends l.default {
						constructor(t, e) {
							var i;
							super(t, e);
							const n = t.getAttribute('data-hs-layout-splitter'),
								o = n ? JSON.parse(n) : {},
								l = Object.assign(Object.assign({}, o), e);
							((this.horizontalSplitterClasses =
								(null == l ? void 0 : l.horizontalSplitterClasses) || null),
								(this.horizontalSplitterTemplate =
									(null == l ? void 0 : l.horizontalSplitterTemplate) ||
									'<div></div>'),
								(this.verticalSplitterClasses =
									(null == l ? void 0 : l.verticalSplitterClasses) || null),
								(this.verticalSplitterTemplate =
									(null == l ? void 0 : l.verticalSplitterTemplate) ||
									'<div></div>'),
								(this.isSplittersAddedManually =
									null !==
										(i = null == l ? void 0 : l.isSplittersAddedManually) &&
									void 0 !== i &&
									i),
						...
						init() {
							(this.createCollection(window.$hsLayoutSplitterCollection, this),
								this.buildSplitters(),
								r.isListenersInitialized ||
									(document.addEventListener(
										'pointermove',
										r.onDocumentPointerMove,
									),
									document.addEventListener('pointerup', r.onDocumentPointerUp),
									(r.isListenersInitialized = !0)));
						}
						buildSplitters() {
						...
						buildControl(t, e, i = 'horizontal') {
							...
							if (this.isSplittersAddedManually) {
								if (((n = null == e ? void 0 : e.previousElementSibling), !n))
									return !1;
								n.style.display = '';
							} else
								((n = (0, o.htmlToElement)(
							...
							const l = { el: n, direction: i, prev: t, next: e };
							('horizontal' === i
								? this.horizontalControls.push(l)
								: this.verticalControls.push(l),
								this.bindListeners(l),
								e &&
									!this.isSplittersAddedManually &&
						...
						getSplitterItemParsedParam(t) {
							...
							return (0, o.isJson)(e) ? JSON.parse(e) : e;
						}
						...
						getMaxFlexSize(t, e, i) {
							const n = this.getSplitterItemSingleParam(t, e);
						...
						updateSingleSplitter(t) {
							const e = t.getAttribute('data-hs-layout-splitter-item'),
								i = (0, o.isJson)(e) ? JSON.parse(e) : e,
								n = (0, o.isJson)(e) ? i.dynamicSize : e;
							t.style.flex = `${n} 1 0`;
						}
						...
						onPointerMoveHandler(t, e, i) {
							const { prev: n, next: o } = e,
								...
								r = 'horizontal' === i,
								s = this.getContainerSize(l, r),
								a = this.calculateAvailableSize(l, n, o, r, s),
								d = this.calculateResizedSizes(t, n, a, r),
								c = this.enforceLimits(d, n, o, s, a);
							this.applySizes(n, o, c, s);
						}
						bindListeners(t) {
							const { el: e } = t;
						...
						calculateAvailableSize(t, e, i, n, o) {
							const l = t.querySelectorAll(
								':scope > [data-hs-layout-splitter-item]',
							);
							return (
								o -
								Array.from(l).reduce((t, o) => {
									if (o === e || o === i) return t;
						...
						calculateResizedSizes(t, e, i, n) {
							const o = n
								? e.getBoundingClientRect().left
								: e.getBoundingClientRect().top;
							let l = Math.max(0, Math.min((n ? t.clientX : t.clientY) - o, i));
							return { previousSize: l, nextSize: i - l };
						}
						enforceLimits(t, e, i, n, l) {
							const r = this.getMaxFlexSize(e, 'minSize', n),
								s = this.getMaxFlexSize(i, 'minSize', n),
								a = this.getMaxFlexSize(e, 'preLimitSize', n),
								d = this.getMaxFlexSize(i, 'preLimitSize', n);
							let { previousSize: c, nextSize: u } = t;
							u < s ? ((u = s), (c = l - u)) : c < r && ((c = r), (u = l - c));
							const p = {
								prev: e,
								next: i,
								...
								nextSize: u.toFixed(),
								nextFlexSize: (u / n) * 100,
								nextPreLimitSize: d,
								nextPreLimitFlexSize: (d / n) * 100,
								nextMinSize: s,
								nextMinFlexSize: (s / n) * 100,
								static: {
									prev: {
							...
							return (
								...
								(0, o.dispatch)('drag.hs.layoutSplitter', this.el, p),
								{ previousSize: c, nextSize: u }
							);
						}
						applySizes(t, e, i, n) {
							const { previousSize: o, nextSize: l } = i,
								r = (o / n) * 100;
							(this.updateSplitterItemParam(t, r),
								(t.style.flex = `${r.toFixed(1)} 1 0`));
							const s = (l / n) * 100;
							(this.updateSplitterItemParam(e, s),
								(e.style.flex = `${s.toFixed(1)} 1 0`));
						}
						...
						getData(t) {
							...
							const o = n.matches('[data-hs-layout-splitter-horizontal-group]'),
								l = this.getContainerSize(n, o),
								r = this.getSplitterItemSingleParam(t, 'dynamicSize') || 0,
								s = this.getMaxFlexSize(t, 'minSize', l),
								a = this.getMaxFlexSize(t, 'preLimitSize', l),
								d = (s / l) * 100,
								c = (a / l) * 100;
							return {
								el: t,
								dynamicSize: +((r / 100) * l).toFixed(),
								dynamicFlexSize: r,
								minSize: +s.toFixed(),
								minFlexSize: d,
							...
							if (
								(t.forEach(({ id: t, breakpoints: n }) => {
									...
									if (o) {
										...
										(this.updateSplitterItemParam(o, t),
											(o.style.flex = `${t.toFixed(1)} 1 0`),
											(e += t));
									}
								}),
								100 !== e)
						...
						destroy() {
							(this.onControlPointerDownListener &&
								...
								0 === window.$hsLayoutSplitterCollection.length &&
									...
									document.removeEventListener(
										'pointerup',
										r.onDocumentPointerUp,
									),
									(r.isListenersInitialized = !1)));
						}
						...
						static on(t, e, i) {
							const n = r.findInCollection(e);
							n && (n.element.events[t] = i);
						}
					}
					((r.isListenersInitialized = !1),
						(r.onDocumentPointerMove = (t) => {
							...
							n &&
								('vertical' === n.direction
									? i.element.onPointerMoveHandler(t, n, 'vertical')
									: i.element.onPointerMoveHandler(t, n, 'horizontal'));
						}),
						(r.onDocumentPointerUp = () => {
							const t = document.querySelector(
								'.hs-layout-splitter-control.dragging',
						...
						'undefined' != typeof window && (window.HSLayoutSplitter = r),
						(e.default = r));
				},
				961: (t, e) => {
					Object.defineProperty(e, '__esModule', { value: !0 });
