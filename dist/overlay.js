		...
		var e = {
				...
				248: (e, t) => {
					...
					t.default = class {
						...
						registerComponent(e, t, i = !0, n = '', o = '', s) {
							const l = {
								wrapper: e,
								handlers: t,
								isOpened: i,
				...
				292: function (e, t) {
					...
					t.isEnoughSpace = (e, t, i = 'auto', n = 10, o = null) => {
						const s = t.getBoundingClientRect(),
							l = o ? o.getBoundingClientRect() : null,
							r = window.innerHeight,
							a = l ? s.top - l.top : s.top,
							d = (o ? l.bottom : r) - s.bottom,
							c = e.clientHeight + n;
						return 'bottom' === i
							? d >= c
							: 'top' === i
					...
					class a extends l.default {
						constructor(e, t, i) {
							...
							((this.hiddenClass =
								...
								(this.isCloseWhenClickInside = (0, o.stringToBoolean)(
									(0, o.getClassProperty)(
										this.el,
										'--close-when-click-inside',
										'false',
									) || 'false',
								)),
								(this.isTabAccessibilityLimited = (0, o.stringToBoolean)(
									(0, o.getClassProperty)(
										this.el,
								...
								(this.isLayoutAffect = (0, o.stringToBoolean)(
									(0, o.getClassProperty)(
										this.el,
										'--is-layout-affect',
										'false',
								...
								(this.hasAutofocus = (0, o.stringToBoolean)(
									(0, o.getClassProperty)(this.el, '--has-autofocus', 'true') ||
										'true',
								)),
								(this.hasDynamicZIndex = (0, o.stringToBoolean)(
									(0, o.getClassProperty)(
										this.el,
										'--has-dynamic-z-index',
										'false',
								...
								(this.hasAbilityToCloseOnBackdropClick = (0, o.stringToBoolean)(
									this.el.getAttribute('data-hs-overlay-keyboard') || 'true',
								)));
							const y = (0, o.getClassProperty)(this.el, '--auto-close'),
								f = (0, o.getClassProperty)(
									this.el,
									'--auto-close-equality-type',
								),
								v = (0, o.getClassProperty)(this.el, '--opened');
							((this.autoClose =
								!isNaN(+y) && isFinite(+y) ? +y : s.BREAKPOINTS[y] || null),
								(this.autoCloseEqualityType =
									null !== (d = f) && void 0 !== d ? d : null),
								(this.openedBreakpoint =
									(!isNaN(+v) && isFinite(+v) ? +v : s.BREAKPOINTS[v]) || null),
						...
						elementClick() {
							const e = () => {
								...
								(this.fireEvent('toggleClicked', e),
									(0, o.dispatch)('toggleClicked.hs.overlay', this.el, e));
							};
						...
						hideAuto() {
							const e = parseInt(
								(0, o.getClassProperty)(this.el, '--auto-hide', '0'),
							);
							e &&
						...
						open(e = null) {
							...
							const t = document.querySelectorAll('.hs-overlay.open'),
								...
								s =
									'true' !==
									(0, o.getClassProperty)(this.el, '--body-scroll', 'false');
							if (
							...
							(s &&
								...
								setTimeout(() => {
									...
									(this.el.classList.add('open', 'opened'),
										...
										(0, o.dispatch)('open.hs.overlay', this.el, this.el),
										window.HSAccessibilityObserver &&
						...
						close(e = !1, t = null) {
							...
							const i = (e) => {
								...
								(document
									...
									(0, o.dispatch)('close.hs.overlay', this.el, this.el),
									window.HSAccessibilityObserver &&
										this.accessibilityComponent &&
										window.HSAccessibilityObserver.updateComponentState(
											this.accessibilityComponent,
							...
							return new Promise((t) => {
								(this.el.classList.remove('open', 'opened'),
									...
									e
										? i(t)
										: (0, o.afterTransition)(this.animationTarget, () => i(t)));
							});
						}
						updateToggles() {
							const e = Array.from(
						...
						static getInstance(e, t) {
							const i = 'string' == typeof e ? document.querySelector(e) : e,
								n = (null == i ? void 0 : i.getAttribute('data-hs-overlay'))
									...
									: e,
								o = window.$hsOverlayCollection.find(
									(e) =>
										e.element.el ===
							...
							window.$hsOverlayCollection
								...
								.forEach((e) => {
									const t = e.element.moveOverlayToBody,
										...
										s = e.element.el;
									if (!i && s) return !1;
									document.body.clientWidth <= t && !(0, o.isDirectChild)(n, s)
										? n.appendChild(s)
