		...
		var t = {
				...
				292: function (t, e) {
					...
					e.getHighestZIndex = (t) => {
						...
						return (
							t.forEach((t) => {
								let o = n(t);
								'auto' !== o && ((o = parseInt(o, 10)), o > e && (e = o));
							}),
							e
						);
					};
					...
					e.isEnoughSpace = (t, e, n = 'auto', o = 10, i = null) => {
					...
					e.classToClassList = (t, e, n = ' ', o = 'add') => {
						t.split(n).forEach((t) => {
							t.trim() &&
								('add' === o ? e.classList.add(t) : e.classList.remove(t));
						});
					};
					const i = {
						historyIndex: -1,
				...
				949: (t, e, n) => {
						...
						let s =
							'x' === i
								...
								: 'start' === o
									? 'bottom'
									: 'top';
						return (e.reference[r] > e.floating[r] && (s = E(s)), [s, E(s)]);
					}
					function T(t) {
					...
					async function A(t, e) {
						...
						const {
							...
							x = ((await (null == r.isElement ? void 0 : r.isElement(v))) &&
					...
					function O(t) {
						const e = s(...t.map((t) => t.left)),
							n = s(...t.map((t) => t.top));
						return {
							x: e,
							y: n,
							width: l(...t.map((t) => t.right)) - e,
							height: l(...t.map((t) => t.bottom)) - n,
						};
					}
					function R() {
					...
					function M(t) {
						var e;
						return null ==
							(e = (B(t) ? t.ownerDocument : t.document) || window.document)
							? void 0
							: e.documentElement;
					}
					function B(t) {
						return !!R() && (t instanceof Node || t instanceof H(t).Node);
					}
					function D(t) {
						return !!R() && (t instanceof Element || t instanceof H(t).Element);
					}
					function F(t) {
						return (
							!!R() &&
							(t instanceof HTMLElement || t instanceof H(t).HTMLElement)
						);
					}
					function k(t) {
						return (
					...
					function z(t) {
						...
						const e =
							t.assignedSlot || t.parentNode || (k(t) && t.host) || M(t);
						return k(e) ? e.host : e;
					}
					function q(t) {
						const e = z(t);
					...
					function Q(t) {
						...
						const n = e.getBoundingClientRect(),
							{ width: o, height: i, $: r } = J(e);
						let s = (r ? a(n.width) : n.width) / o,
							l = (r ? a(n.height) : n.height) / i;
						return (
					...
					function nt(t, e, n, o) {
						...
						return C({ width: f, height: h, x: a, y: c });
					}
					function ot(t, e) {
						const n = K(t).scrollLeft;
						return e ? e.left + n : nt(M(t)).left + n;
					}
					function it(t, e, n) {
						void 0 === n && (n = !1);
						const o = t.getBoundingClientRect();
						return {
							x: o.left + e.scrollLeft - (n ? 0 : ot(t, o)),
							y: o.top + e.scrollTop,
						};
					}
					function rt(t, e, n) {
						...
						if ('viewport' === e)
							o = (function (t, e) {
								...
								return { width: r, height: s, x: l, y: a };
							})(t, n);
						else if ('document' === e)
							o = (function (t) {
								const e = M(t),
								...
								return (
									'rtl' === j(o).direction &&
										(s += l(e.clientWidth, o.clientWidth) - i),
									{ width: i, height: r, x: s, y: a }
								);
							})(M(t));
						else if (D(e))
							o = (function (t, e) {
								const n = nt(t, !0, 'fixed' === e),
									o = n.top + t.clientTop,
					...
					function lt(t, e, n) {
						...
						const a = u(0);
						if (o || (!o && !r))
							if ((('body' !== _(e) || Y(i)) && (l = K(e)), o)) {
								const t = nt(e, !0, r, e);
								((a.x = t.x + e.clientLeft), (a.y = t.y + e.clientTop));
							} else i && (a.x = ot(i));
						const c = !i || o || r ? u(0) : it(i, l);
						return {
							x: s.left + l.scrollLeft - a.x - c.x,
							y: s.top + l.scrollTop - a.y - c.y,
							width: s.width,
							height: s.height,
						};
					}
					...
					function ct(t, e) {
						if (!F(t) || 'fixed' === j(t).position) return null;
						if (e) return e(t);
					...
					function ut(t, e) {
						...
						if (!F(t)) {
							let e = z(t);
							for (; e && !V(e); ) {
								if (D(e) && !at(e)) return e;
								e = z(e);
							}
							return n;
						}
						let o = ct(t, e);
						for (; o && U(o) && at(o); ) o = ct(o, e);
						return o && V(o) && at(o) && !W(o)
							? n
							: o ||
									(function (t) {
										let e = z(t);
					...
					const ft = {
						convertOffsetParentRelativeRectToViewportRelativeRect: function (
							...
							const d = !s || h || r ? u(0) : it(s, a, !0);
							return {
								width: n.width * c.x,
								height: n.height * c.y,
								x: n.x * c.x - a.scrollLeft * c.x + f.x + d.x,
								y: n.y * c.y - a.scrollTop * c.y + f.y + d.y,
							};
						},
										...
										return (
											(function a(u, f) {
												...
												const h = t.getBoundingClientRect(),
													{ left: d, top: g, width: p, height: m } = h;
												if ((u || e(), !p || !m)) return;
												const y = {
													rootMargin:
														-c(g) +
														...
														-c(i.clientWidth - (d + p)) +
														'px ' +
														-c(i.clientHeight - (g + m)) +
														'px ' +
														-c(d) +
														'px',
													threshold: l(0, s(1, f)) || 1,
												};
												let w = !0;
												function v(e) {
													...
													(1 !== o || ht(h, t.getBoundingClientRect()) || a(),
														(w = !1));
												}
												try {
							...
							return (
								void 0 === t && (t = {}),
								{
									...
									async fn(e) {
										...
										const S = [x[p(L)], x[C[0]], x[C[1]]],
											I = [
												...((null == (o = l.autoPlacement)
													? void 0
													: o.overflows) || []),
												{ placement: L, overflows: S },
											],
											P = v[E + 1];
										if (P)
											return {
												data: { index: E + 1, overflows: I },
												reset: { placement: P },
											};
										const O = I.map((t) => {
											...
											R =
												(null ==
												(i = O.filter((t) =>
													t[2].slice(0, m(t[0]) ? 2 : 3).every((t) => t <= 0),
												)[0])
													? void 0
													: i[0]) || O[0][0];
										return R !== a
								...
								void 0 === t && (t = {}),
								{
									...
									async fn(e) {
										...
										if (r) {
											...
											m = d(m + u['y' === h ? 'top' : 'left'], m, m - u[t]);
										}
										if (s) {
											const t = 'y' === f ? 'bottom' : 'right';
											w = d(w + u['y' === f ? 'top' : 'left'], w, w - u[t]);
										}
										const x = l.fn({ ...e, [h]: m, [f]: w });
										return {
											...x,
											data: {
												x: x.x - n,
								...
								void 0 === t && (t = {}),
								{
									...
									async fn(e) {
										...
										const R = [l, ...P],
											_ = await A(e, x),
											H = [];
										let M = (null == (o = r.flip) ? void 0 : o.overflows) || [];
										if ((u && H.push(_[L]), f)) {
											const t = b(i, s, I);
											H.push(_[t[0]], _[t[1]]);
										}
										if (
											((M = [...M, { placement: i, overflows: H }]),
											!H.every((t) => t <= 0))
										) {
											var B, D;
											const t =
													((null == (B = r.flip) ? void 0 : B.index) || 0) + 1,
												e = R[t];
											if (e)
												return {
											...
											let n =
												null ==
												(D = M.filter((t) => t.overflows[0] <= 0).sort(
							...
							return (
								void 0 === t && (t = {}),
								{
									...
									async fn(e) {
											...
											? ((T = d),
												(E =
													...
													((await (null == a.isRTL
														...
														? 'left'
														: 'right'))
											: ((E = d), (T = 'end' === y ? 'top' : 'bottom'));
										const L = b - h.top - h.bottom,
											C = x - h.left - h.right,
											S = s(b - h[T], L),
											I = s(x - h[E], C),
										...
										await u({ ...e, availableWidth: R, availableHeight: O });
										const _ = await a.getDimensions(c.floating);
										return x !== _.width || b !== _.height
											? { reset: { rects: !0 } }
											: {};
									},
								}
						...
						xt = function (t) {
							return (
								void 0 === t && (t = {}),
								{
									...
									async fn(e) {
										const { rects: n } = e,
											{ strategy: o = 'referenceHidden', ...i } = g(t, e);
										switch (o) {
						...
						bt = (t) => ({
							...
							async fn(e) {
								const {
									...
									{ element: u, padding: f = 0 } = g(t, e) || {};
								if (null == u) return {};
								const h = L(f),
									p = { x: n, y: o },
									y = x(i),
									v = w(y),
									b = await l.getDimensions(u),
									T = 'y' === y,
									E = T ? 'top' : 'left',
									C = T ? 'bottom' : 'right',
									S = T ? 'clientHeight' : 'clientWidth',
									A = r.reference[v] + r.reference[y] - p[y] - r.floating[v],
									I = p[y] - r.reference[y],
								...
								const R = A / 2 - I / 2,
									...
									Y =
										...
										null != m(i) &&
										F !== k &&
										r.reference[v] / 2 - (F < B ? H : M) - b[v] / 2 < 0,
									U = Y ? (F < B ? F - B : F - D) : 0;
								return {
									[y]: p[y] + U,
									data: {
									...
									fn(e) {
										...
										if (a) {
											const t = 'y' === h ? 'height' : 'width',
												e = r.reference[h] - r.floating[t] + x.mainAxis,
												n = r.reference[h] + r.reference[t] - x.mainAxis;
											d < e ? (d = e) : d > n && (d = n);
										}
										if (c) {
											var b, T;
				...
				969: function (t, e, n) {
					...
					class c extends l.default {
						constructor(t, e, n) {
							(super(t, e, n),
								...
								this.el &&
									...
									(this.eventMode =
										(0, s.getClassProperty)(this.el, '--trigger') || 'hover'),
									(this.preventFloatingUI = (0, s.getClassProperty)(
										this.el,
										'--prevent-popper',
										'false',
									)),
									(this.placement =
										(0, s.getClassProperty)(this.el, '--placement') || 'top'),
									(this.strategy = (0, s.getClassProperty)(
										this.el,
										'--strategy',
									)),
									(this.scope =
										(0, s.getClassProperty)(this.el, '--scope') || 'parent')),
							...
							return o(this, void 0, void 0, function* () {
								const e = 'auto' === t ? 'top' : t,
									n =
										'auto' === t
											? ['bottom', 'left', 'right']
											: this.getFallbackPlacements(e),
									o = [
										(0, r.offset)(5),
										(0, r.flip)({ fallbackPlacements: n }),
									];
								return yield (0, r.computePosition)(this.toggle, this.content, {
									placement: e,
						...
						applyTooltipPosition(t, e, n) {
							(Object.assign(this.content.style, {
								position: this.strategy || 'fixed',
								left: `${t}px`,
								top: `${e}px`,
							}),
								this.content.setAttribute('data-placement', n));
						}
						buildFloatingUI() {
							'window' === this.scope &&
								document.body.appendChild(this.content);
							const t = this.placement.startsWith('auto'),
								e = (0, s.getClassProperty)(this.el, '--placement'),
								n =
									t || !e || '' === e
										? 'auto'
										: a.POSITIONS[this.placement] || this.placement;
							(this.positionTooltip(n).then((t) => {
								this.applyTooltipPosition(t.x, t.y, t.placement);
							}),
								(this.cleanupAutoUpdate = (0, r.autoUpdate)(
									this.toggle,
									this.content,
									() => {
										this.positionTooltip(n).then((t) => {
							...
							(this.content.classList.remove('hidden'),
								...
								setTimeout(() => {
									(this.el.classList.add('show'),
										...
										(0, s.dispatch)('show.hs.tooltip', this.el, this.el));
								}));
						}
						show() {
						...
						hide() {
							(this.el.classList.remove('show'),
								...
								(0, s.dispatch)('hide.hs.tooltip', this.el, this.el),
						...
						static autoInit() {
							(window.$hsTooltipCollection ||
								...
								window.$hsTooltipCollection &&
									(window.$hsTooltipCollection =
										window.$hsTooltipCollection.filter(({ element: t }) =>
					...
					(window.addEventListener('load', () => {
						...
						'undefined' != typeof window && (window.HSTooltip = c),
						(e.default = c));
				},
			},
			e = {};
