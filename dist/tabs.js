		...
		var e = {
				166: function (e, t, n) {
					...
					class a extends r.default {
						constructor(e, t, n) {
							var o, i;
							super(e, t, n);
							const r = e.getAttribute('data-hs-tabs'),
								s = r ? JSON.parse(r) : {},
								a = Object.assign(Object.assign({}, s), t);
							((this.eventType =
								null !== (o = a.eventType) && void 0 !== o ? o : 'click'),
								...
								(this.currentContentId =
									(null === (i = this.current) || void 0 === i
										? void 0
										: i.getAttribute('data-hs-tab')) || null),
						...
						open(e) {
							...
							((this.prev = this.current),
								...
								null === (o = this.prevContent) ||
									void 0 === o ||
									o.classList.add('hidden'),
								(null === (r = null == this ? void 0 : this.current) ||
								void 0 === r
									? void 0
									: r.ariaSelected) && (this.current.ariaSelected = 'true'),
								this.current.classList.add('active'),
								null === (s = this.currentContent) ||
									void 0 === s ||
						...
						onArrow(e = !0) {
							const t = e
								...
								n = t.find((e) => document.activeElement === e);
							let o = t.findIndex((e) => e === n);
							((o = o + 1 < t.length ? o + 1 : 0), t[o].focus(), t[o].click());
						}
						onStartEnd(e = !0) {
							const t = e
								? Array.from(this.toggles)
						...
						destroy() {
							(this.toggles.forEach((e) => {
								...
								n &&
									('click' === this.eventType
										? e.removeEventListener('click', n.fn)
										: (e.removeEventListener('mouseenter', n.fn),
											e.removeEventListener('click', n.preventClickFn)));
							}),
								(this.onToggleHandler = []),
								this.extraToggle &&
				...
				248: (e, t) => {
					...
					t.default = class {
						...
						registerComponent(e, t, n = !0, o = '', i = '', r) {
							const s = {
								wrapper: e,
								handlers: t,
								isOpened: n,
