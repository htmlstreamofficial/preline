	...
	(() => {
		...
		var t = {
					...
					class l extends r.default {
						constructor(t, e) {
							...
							((this.currentIndex = a.currentIndex || 0),
								(this.loadingClasses = a.loadingClasses
									...
									: null),
								(this.dotsItemClasses = a.dotsItemClasses
									? a.dotsItemClasses
									: null),
								(this.isAutoHeight =
									void 0 !== a.isAutoHeight && a.isAutoHeight),
								...
								(this.isInfiniteLoop =
									void 0 !== a.isInfiniteLoop && a.isInfiniteLoop),
								(this.isRTL = void 0 !== a.isRTL && a.isRTL),
								(this.isSnap = void 0 !== a.isSnap && a.isSnap),
								(this.hasSnapSpacers =
									void 0 === a.hasSnapSpacers || a.hasSnapSpacers),
								...
								(this.infoTotal =
									(null === (r = null == this ? void 0 : this.info) ||
									void 0 === r
										? void 0
						...
						init() {
							(this.createCollection(window.$hsCarouselCollection, this),
								...
								this.isSnap ||
									((this.onElementTouchStartListener = (t) =>
										this.elementTouchStart(t)),
									(this.onElementTouchEndListener = (t) =>
										this.elementTouchEnd(t)),
						...
						initDragHandling() {
							...
							((this.onInnerMouseDownListener = (t) => this.innerMouseDown(t)),
								(this.onInnerTouchStartListener = (t) =>
									this.innerTouchStart(t)),
								(this.onDocumentMouseMoveListener = (t) =>
									this.documentMouseMove(t)),
								(this.onDocumentTouchMoveListener = (t) =>
									this.documentTouchMove(t)),
								...
								return (
									Object.keys(this.slidesQty).forEach((s) => {
										t >=
											(typeof s + 1 == 'number'
												? this.slidesQty[s]
												: o.BREAKPOINTS[s]) && (e = this.slidesQty[s]);
									}),
									e
								);
							}
						...
						buildSingleDot(t) {
							const e = (0, n.htmlToElement)('<span></span>');
							return (
								this.dotsItemClasses &&
									(0, n.classToClassList)(this.dotsItemClasses, e),
						...
						calculateTransform(t) {
							...
							(this.isSnap || this.setTransform(i),
								this.isAutoHeight &&
						...
						destroy() {
							...
							if (
								...
								((
									...
									t.removeEventListener('click', this.onDotClickListener),
								),
						...
						static autoInit() {
							(window.$hsCarouselCollection ||
								...
								window.$hsCarouselCollection &&
									(window.$hsCarouselCollection =
										window.$hsCarouselCollection.filter(({ element: t }) =>
				...
				292: function (t, e) {
					...
					e.isEnoughSpace = (t, e, s = 'auto', i = 10, n = null) => {
						const r = e.getBoundingClientRect(),
							o = n ? n.getBoundingClientRect() : null,
							l = window.innerHeight,
							h = o ? r.top - o.top : r.top,
							a = (n ? o.bottom : l) - r.bottom,
							d = t.clientHeight + i;
						return 'bottom' === s
							? a >= d
							: 'top' === s
